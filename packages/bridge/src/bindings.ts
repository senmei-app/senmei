...
export const commands = {
	...
	render: (input: string, output: string, scale: number | null, modelId: string | null, onProgress: Channel<RenderProgress>) => __TAURI_INVOKE<string>("render", { input, output, scale, modelId, onProgress }),
