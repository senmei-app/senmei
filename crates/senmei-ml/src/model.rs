...
mod tests {
    ...
    fn registry_loads_example_metadata() {
        ...
        assert_eq!(registry.models()[13].id, "dncnn-color");
        assert!(matches!(registry.models()[13].kind, ModelKind::Denoise));
        assert_eq!(registry.models()[13].arch, "dncnn");
        assert_eq!(registry.models()[13].scale, 1);
        assert!(registry.models()[13].loadable);
        assert_eq!(registry.models()[13].license.as_deref(), Some("MIT"));
        assert_eq!(registry.models()[13].sha256.as_deref().unwrap().len(), 64);
        ...
        assert_eq!(registry.models()[32].id, "ffdnet-color");
        assert!(matches!(registry.models()[32].kind, ModelKind::Denoise));
        assert_eq!(registry.models()[32].arch, "ffdnet");
        assert_eq!(registry.models()[32].scale, 1);
        assert!(registry.models()[32].loadable);
        assert_eq!(registry.models()[32].license.as_deref(), Some("MIT"));
        assert_eq!(registry.models()[32].sha256.as_deref().unwrap().len(), 64);
        assert_eq!(registry.models()[33].id, "real-plksr-2x-public");
        assert!(matches!(registry.models()[33].kind, ModelKind::Upscale));
        assert_eq!(registry.models()[33].scale, 2);
        assert_eq!(registry.models()[33].arch, "real-plksr");
        ...
        assert_eq!(registry.models()[36].id, "safmn-real-x2");
        assert!(matches!(registry.models()[36].kind, ModelKind::Upscale));
        assert_eq!(registry.models()[36].scale, 2);
        assert_eq!(registry.models()[36].arch, "safmn");
        assert!(registry.models()[36].loadable);
        assert_eq!(registry.models()[36].license.as_deref(), Some("Apache-2.0"));
        assert_eq!(registry.models()[36].sha256.as_deref().unwrap().len(), 64);
        assert_eq!(registry.models()[37].id, "safmn-real-x4");
        assert_eq!(registry.models()[37].arch, "safmn");
        assert_eq!(registry.models()[37].scale, 4);
        ...
        assert_eq!(registry.models()[40].arch, "upcunet2x");
        assert!(registry.models()[40].loadable);
        assert_eq!(registry.models()[41].id, "paragonsr-nano-x2");
        assert_eq!(registry.models()[41].arch, "paragonsr");
        assert!(registry.models()[41].loadable);
